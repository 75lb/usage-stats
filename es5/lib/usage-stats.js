...
var UsageStatsAbortable = function (_UsageStats) {
  ...
  function UsageStatsAbortable(trackingId, options) {
    ...
    var _this3 = _possibleConstructorReturn(this, (UsageStatsAbortable.__proto__ || Object.getPrototypeOf(UsageStatsAbortable)).call(this, trackingId, options));

    _this3._requestControllers = [];
    return _this3;
  }
    ...
    value: function send(options) {
      ...
      if (options.timeout) {
        (function () {
          ...
          sendPromise = _get(UsageStatsAbortable.prototype.__proto__ || Object.getPrototypeOf(UsageStatsAbortable.prototype), 'send', _this4).call(_this4).then(function (responses) {
            endTimeout();
            return responses;
          }).catch(function (err) {
            endTimeout();
